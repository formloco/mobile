...
@Component({
  selector: 'app-fire-extinguisher-job-details',
  templateUrl: './fire-extinguisher-job-details.component.html',
  styleUrls: ['./fire-extinguisher-job-details.component.scss']
})
export class FireExtinguisherJobDetailsComponent implements OnChanges {
